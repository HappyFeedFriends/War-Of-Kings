...
GOLD_TICK_TIME = 9000              		-- How long should we wait in seconds between gold ticks?
...
FORCE_PICKED_HERO = 'npc_dota_hero_wisp'--"npc_dota_hero_target_dummy"
...
STARTING_GOLD = 999999 -- 5200                     -- How much starting gold should we give to each player?
