function Spawn( entityKeyValues ) 
    ...
    ability1 = thisEntity:FindAbilityByName( "dark_willow_1" )
    ability2 = thisEntity:FindAbilityByName( "dark_willow_2" )
    ability3 = thisEntity:FindAbilityByName( "dark_willow_3" )
	thisEntity:SetContextThink( "Think", ThinkEntity, 1 ) 
end

function ThinkEntity()
	if ability1:IsFullyCastable() and ability1:GetAutoCastState() and thisEntity:GetAttackTarget() then
